			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="state.php" class=""><i class="lnr lnr-code"></i> <span>Province</span></a></li>
						...
						<li><a href="log.php" class=""><i class="lnr lnr-alarm"></i> <span>Activity Log </span></a></li>
						<li><a href="list.php" class=""><i class="lnr lnr-chart-bars"></i> <span>  </span></a></li>
